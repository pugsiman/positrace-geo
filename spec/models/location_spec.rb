  ...
  describe '#update_geolocation!' do
    ...
    context 'with valid identifier' do
      ...
      it 'saves the matching geolocation data' do
        expect { location.update_geolocation!(client: client_stub) }.to change { location.lonlat }
    ...
    context 'without valid identifier' do
      ...
      it 'raises an error' do
        expect { location.update_geolocation!(client: client_stub) }.to raise_error StandardError
      end
    end
  end
end
